...
app.get('/api/music/account', (req, res) => send(res, ncm.login_status, {}, userCookie(req)))
app.get('/api/music/playlist', (req, res) => send(res, ncm.user_playlist, { uid: req.header('x-user-id'), limit: 100 }, userCookie(req)))
